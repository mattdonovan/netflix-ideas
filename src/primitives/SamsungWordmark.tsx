...
export function SamsungWordmark({
  ...
  return (
    <Box
      ...
      role="img"
      aria-label="Samsung"
      sx={{ height, width, display: "inline-block", flexShrink: 0, color }}
    >
      <path d={SAMSUNG_PATH} fill="currentColor" />
    </Box>
  );
}
